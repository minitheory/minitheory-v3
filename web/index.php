...
$app->get('/jobs', function() use ($app) {
    return $app['twig']->render('jobs.html.haml');
})
->bind('jobs');

$app->get('/global', function() use ($app) {
    return $app['twig']->render('global.html.haml');
})
->bind('global');
...
$app->get('/work/shopabout', function() use ($app) {
    return $app['twig']->render('work/shopabout.html.haml');
})
->bind('work_shopabout');
